...
/**
 * Anzeige-Logik des „Was ist neu?"-Fensters (#308).
 *
...
class WhatsNewServiceTest extends TestCase {
	...
	protected function setUp(): void {
		parent::setUp();
		$this->appDir = sys_get_temp_dir() . '/rw-whatsnew-' . bin2hex(random_bytes(6));
	...
	public function testDieAusgelieferteDateiIstGueltig(): void {
		$file = dirname(__DIR__, 2) . '/whatsnew/whatsnew.json';
	...
	public function testAppIdBleibtDerAblageortDerMarke(): void {
		...
		self::assertSame('rechnungswerk', Application::APP_ID);
	}
}
