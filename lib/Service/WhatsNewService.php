...
/**
 * „Was ist neu?"-Fenster (Baustein 0b, Pilot #308).
 *
 ...
 *
 * Diese Klasse ist die Vorlage fuer die uebrigen Apps der Flotte; sie haelt
 * deshalb keine RechnungsWerk-Besonderheiten.
 */
class WhatsNewService {
	 ...
	 * gesetzt von {@see \OCA\Rechnungswerk\Migration\WhatsNewBootstrap}.
	...
	private function readCatalogue(): array {
		...
		foreach ($decoded as $version => $entries) {
			...
			// x.y.z-Schema kommt das nicht vor, aber die Vorlage wandert in vier
			// weitere Apps — dort faellt ein stilles continue niemandem auf.
