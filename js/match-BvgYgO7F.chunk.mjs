...
var r = {
	...
	let i, a = r[e];
	return i = typeof a == "string" ? a : t === 1 ? a.one : a.other.replace("{{count}}", String(t)), n?.addSuffix ? n.comparison && n.comparison > 0 ? "dans " + i : "il y a " + i : i;
}, a = {
	...
	preprocessor: (e, t) => e.getDate() === 1 || !t.some((e) => e.isToken && d.includes(e.value)) ? t : t.map((e) => e.isToken && e.value === "do" ? {
		isToken: !0,
		value: "d"
	} : e),
	ordinalNumber: u,
