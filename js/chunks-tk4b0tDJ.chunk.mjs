...
import { $ as n, $t as r, A as i, At as a, Cn as o, Ct as s, D as c, E as l, Et as u, Ft as d, Gt as f, Ht as p, It as m, Jt as h, Kt as g, Lt as _, O as v, P as y, Qt as b, Vt as ee, Xt as te, Yt as ne, Zt as x, _t as S, b as C, bn as w, bt as T, cn as E, ct as re, d as ie, dn as D, dt as ae, en as O, et as oe, ft as se, gn as ce, gt as k, ht as A, i as j, in as M, jt as le, kt as N, ln as ue, lt as de, mn as P, mt as F, nt as fe, on as pe, ot as I, pn as me, r as L, t as he, tn as R, u as ge, un as _e, ut as z, vn as B, vt as V, wt as ve, x as ye, xt as H, y as be, yn as U } from "./createElementId-DhjFt1I9-C3zSrX7C.chunk.mjs";
import { d as xe, f as Se, i as Ce, n as we, p as Te, t as Ee } from "./NcPopover-B87bEPLq-Bfc7fZbF.chunk.mjs";
import { C as De, E as W, S as Oe, T as G, c as ke, d as Ae, m as je, r as Me, t as Ne, u as Pe, y as Fe } from "./mdi-CpchYUUV-BlQjFBKG.chunk.mjs";
...
var Le = 1024;
Le / 2;
var K = (e) => document.documentElement.clientWidth < e, Re = D(K(Le)), ze = D(K(512));
window.addEventListener("resize", () => {
	Re.value = K(Le), ze.value = K(512);
}, { passive: !0 });
function Be() {
	return _e(Re);
}
//#endregion
//#region node_modules/@nextcloud/vue/dist/chunks/useNcActions-BzPO2c4h.mjs
var Ve = /* @__PURE__ */ Symbol.for("NcActions:isSemanticMenu"), He = /* @__PURE__ */ Symbol.for("NcActions:closeMenu");
//#endregion
//#region node_modules/@nextcloud/vue/dist/chunks/useTrapStackControl-B6cEicto.mjs
function Ue(e, t = {}) {
	let n = xe();
	b(e, () => {
		B(t.disabled) || (B(e) ? n.pause() : n.unpause());
	}), m(() => {
		n.unpause();
	});
}
//#endregion
//#region node_modules/@nextcloud/vue/dist/chunks/NcActions-C-wDqSrv.mjs
var We = {
...
function Ye(e, t, n, r, i, s) {
	return _(), V("span", a(e.$attrs, {
		...
		height: n.size,
		viewBox: "0 0 24 24"
	}, [A("path", qe, [n.title ? (_(), V("title", Je, o(n.title), 1)) : S("", !0)])], 8, Ke))], 16, Ge);
}
...
function Ze(e) {
	return Array.isArray(e) && e.some((e) => {
		...
		if (typeof e == "object") {
			let t = e;
			if (t.type === de || t.type === z && !Ze(t.children) || t.type === se && !t.children.trim()) return !1;
		}
		return !0;
	});
}
var Qe = ".focusable", $e = {
	...
	provide() {
		return {
			[Ve]: F(() => this.actionsMenuSemanticType === "menu"),
			[He]: this.closeMenu
		};
	},
	props: {
	...
	created() {
		Ue(() => this.opened, { disabled: () => this.config.withFocusTrap }), "ariaHidden" in this.$attrs && x("[NcActions]: Do not set the ariaHidden attribute as the root element will inherit the incorrect aria-hidden.");
	},
	methods: {
		getActionName(e) {
			return e?.type?.name;
	...
	render() {
		let e = [], t = (e, n) => {
			e.forEach((e) => {
				...
				e.type === z && t(e.children, n);
			});
		};
		if (t(this.$slots.default?.(), e), e.length === 0) return;
		let n = e.filter(this.isValidSingleAction);
		this.forceMenu && n.length > 0 && this.inline > 0 && (x("Specifying forceMenu will ignore any inline actions rendering."), n = []);
		let r = n.slice(0, this.inline), i = e.filter((e) => !r.includes(e)), o = [
			"NcActionButton",
			"NcActionButtonGroup",
			"NcActionCheckbox",
			"NcActionRadio"
		], s = ["NcActionInput", "NcActionTextEditable"], c = ["NcActionLink", "NcActionRouter"], l = i.some((e) => s.includes(this.getActionName(e))), d = i.some((e) => o.includes(this.getActionName(e))), f = i.some((e) => c.includes(this.getActionName(e)));
		this.actionsMenuSemanticType = l ? "dialog" : d ? "menu" : f ? "navigation" : e.filter((e) => this.getActionName(e).startsWith("NcAction")).length === e.length ? "tooltip" : "unknown";
		let p = (e) => {
			let t = e?.props?.icon, n = e?.children?.icon?.()?.[0] ?? (this.isIconUrl(t) ? u("img", {
				class: "action-item__menutoggle__icon",
				src: t,
				alt: ""
			}) : u("span", { class: ["icon", t] })), r = e?.children?.default?.()?.[0]?.children?.trim(), i = this.forceName ? r : "", o = e?.props?.title;
			this.forceName || o || (o = r);
			let s = { ...e?.props ?? {} }, c = ["submit", "reset"].includes(s.type) ? s.modelValue : "button";
			return delete s.modelValue, delete s.type, u(W, a(s, {
			...
			let t = Ze(this.$slots.icon?.()) ? this.$slots.icon?.() : this.defaultIcon ? u("span", { class: ["icon", this.defaultIcon] }) : u(Xe, { size: 20 }), n = `${this.randomId}-trigger`;
			return u(Ee, {
				ref: "popover",
				delay: 0,
				shown: this.opened,
		...
		}), r.length > 0 && this.inline > 0 ? u("div", { class: ["action-items", `action-item--${this.triggerButtonVariant}`] }, [...r.map(p), i.length > 0 ? u("div", { class: ["action-item", { "action-item--open": this.opened }] }, [m(i)]) : null]) : u("div", { class: [
...
}, et = /* @__PURE__ */ c($e, [["__scopeId", "data-v-23e5cae7"]]);
//#endregion
...
var it = Object.prototype.toString, at = (e) => it.call(e) === "[object Object]";
function J(e) {
...
function ct(e, t = 1e3, n = {}) {
	let { immediate: r = !0, immediateCallback: i = !1 } = n, a = null, o = P(!1);
	function s() {
	...
	return r && q && l(), (pe(t) || typeof t == "function") && rt(b(t, () => {
		o.value && q && l();
	})), rt(c), {
		isActive: me(o),
		pause: c,
...
function Z(...e) {
	let t = (e, t, n, r) => (e.addEventListener(t, n, r), () => e.removeEventListener(t, n, r)), n = F(() => {
		let t = J(B(e[0])).filter((e) => e != null);
		return t.every((e) => typeof e != "string") ? t : void 0;
	});
	return lt(() => [
		n.value?.map((e) => X(e)) ?? [Y].filter((e) => e != null),
		J(B(n.value ? e[1] : e[0])),
		J(U(n.value ? e[2] : e[1])),
		B(n.value ? e[3] : e[2])
	], ([e, n, r, i], a, o) => {
		if (!e?.length || !n?.length || !r?.length) return;
		let s = at(i) ? { ...i } : i, c = e.flatMap((e) => n.flatMap((n) => r.map((r) => t(e, n, r, s))));
		o(() => {
			c.forEach((e) => e());
		});
	}, { flush: "post" });
...
function pt(...e) {
	...
	let { target: i = Y, eventName: a = "keydown", passive: o = !1, dedupe: s = !1 } = r, c = ft(t);
	return Z(i, a, (e) => {
		e.repeat && B(s) || c(e) && n(e);
	}, o);
}
function mt(e, t, n = {}) {
	let { window: r = Y, ...i } = n, a, o = /* @__PURE__ */ dt(() => r && "ResizeObserver" in r), s = () => {
...
function ht(e, t = {
	...
	let { window: r = Y, box: i = "content-box" } = n, a = F(() => {
		var t;
		return (t = X(e)) == null || (t = t.namespaceURI) == null ? void 0 : t.includes("svg");
	}), o = P(t.width), s = P(t.height), { stop: c } = mt(e, ([t]) => {
...
function gt(e, t = {}) {
	let { threshold: n = 50, onSwipe: r, onSwipeEnd: i, onSwipeStart: a, passive: o = !0 } = t, s = ue({
		...
		x: 0,
		y: 0
	}), l = F(() => s.x - c.x), u = F(() => s.y - c.y), { max: d, abs: f } = Math, p = F(() => d(f(l.value), f(u.value)) >= n), m = P(!1), h = F(() => p.value ? f(l.value) > f(u.value) ? l.value > 0 ? "left" : "right" : u.value > 0 ? "up" : "down" : "none"), g = (e) => [e.touches[0].clientX, e.touches[0].clientY], _ = (e, t) => {
		s.x = e, s.y = t;
	}, v = (e, t) => {
		c.x = e, c.y = t;
	}, y = {
		...
		Z(e, "touchmove", (e) => {
			if (e.touches.length !== 1) return;
			let [t, n] = g(e);
			v(t, n), y.capture && !y.passive && Math.abs(l.value) > Math.abs(u.value) && e.preventDefault(), !m.value && p.value && (m.value = !0), m.value && r?.(e);
		}, y),
		Z(e, ["touchend", "touchcancel"], (e) => {
...
//#endregion
//#region node_modules/@nextcloud/vue/dist/chunks/NcNoteCard-mI7qVZ9j.mjs
var _t = ["role"], vt = {
	key: 0,
	class: "notecard__heading"
}, yt = { class: "notecard__text" }, bt = /* @__PURE__ */ c(/* @__PURE__ */ s({
	__name: "NcNoteCard",
	props: {
	...
	setup(e) {
		let t = e, n = F(() => t.showAlert || t.type === "error"), r = F(() => {
			switch (t.type) {
				case "error": return Me;
				case "success": return ke;
				case "info": return Fe;
				default: return Ne;
			}
		});
		...
		}, [p(t.$slots, "icon", {}, () => [H(U(G), {
			path: r.value,
			class: w(["notecard__icon", { "notecard__icon--heading": e.heading }]),
			inline: ""
		}, null, 8, ["path", "class"])], !0), A("div", null, [e.heading ? (_(), V("p", vt, o(e.heading), 1)) : S("", !0), p(t.$slots, "default", {}, () => [A("p", yt, o(e.text), 1)], !0)])], 10, _t));
	}
}), [["__scopeId", "data-v-6be9fa31"]]);
//#endregion
//#region node_modules/@nextcloud/vue/dist/chunks/NcDialogButton.vue_vue_type_script_setup_true_lang-Bqfy678u.mjs
L(be);
var xt = /* @__PURE__ */ s({
	...
	setup(e, { emit: t }) {
		...
		return (t, n) => (_(), k(U(W), {
			...
			icon: O(() => [p(t.$slots, "icon", {}, () => [i.value ? (_(), k(U(Ie), {
				key: 0,
				name: U(j)("Loading\xA0…")
			}, null, 8, ["name"])) : e.icon === void 0 ? S("", !0) : (_(), k(U(G), {
				key: 1,
				svg: e.icon
			}, null, 8, ["svg"]))])]),
			default: O(() => [T(o(e.label) + " ", 1)]),
			_: 3
		}, 8, [
			"aria-label",
			"disabled",
...
L(ie);
var St = {
	long: j("a few seconds ago"),
	short: j("seconds ago"),
	narrow: j("sec. ago")
};
function Ct(e = Date.now(), t = {}) {
	let n, a = F(() => new Date(B(e))), o = F(() => {
		let { language: e, relativeTime: n, ignoreSeconds: r } = B(t);
		return {
			...e && { language: e },
			...n && { relativeTime: n },
	...
	r(() => c());
	function c() {
		if (s.value = i(a.value, o.value), B(t).update !== !1) {
			let t = Math.abs(Date.now() - new Date(B(e)).getTime()), r = t > 12e4 || o.value.ignoreSeconds ? Math.min(t / 60, 18e5) : 1e3;
			n = window.setTimeout(c, r);
		}
	}
	return m(() => n && window.clearTimeout(n)), _e(s);
}
function wt(e, t) {
	let n = F(() => ({
		locale: y(),
		...
		...B(t)
	})), r = F(() => new Intl.DateTimeFormat(n.value.locale, n.value.format));
	return F(() => r.value.format(B(e)));
}
//#endregion
//#region node_modules/@nextcloud/vue/dist/chunks/platform-CC2ecGvV.mjs
...
function jt(e, t = () => {}, n = {}) {
	if (Et) return () => {};
	let r = (e, t) => e.key === t ? !0 : n.caseSensitive && t === t.toLowerCase() != (e.key === e.key.toLowerCase()) ? !1 : Dt.test(t) && Ot.test(e.key) ? e.code.replace(/^(?:Key|Digit|Numpad)/, "") === t.toUpperCase() : e.key.toLowerCase() === t.toLowerCase(), i = (t) => typeof e == "function" ? e(t) : typeof e == "string" ? r(t, e) : !Array.isArray(e) || e.some((e) => r(t, e)), a = pt(i, At(t, n), {
		eventName: "keydown",
		dedupe: !0,
		passive: !n.prevent
	}), o = n.push ? pt(i, At(t, n), {
		eventName: "keyup",
		passive: !n.prevent
	}) : () => {};
	return () => {
...
//#endregion
//#region node_modules/@nextcloud/vue/dist/chunks/NcModal-DiDvgcU8.mjs
function Ft(e) {
	return e.parent ? "vapor" in e || "vapor" in e.parent ? (x("Vapor instances are not supported in useScopeIdAttrs :("), null) : e.parent.subTree === e.vnode ? e.parent : null : null;
}
function It(e) {
	let t = [e], n = Ft(e);
...
L(ge, C);
var Rt = ["aria-labelledby", "aria-describedby"], zt = ["data-theme-light", "data-theme-dark"], Bt = ["id"], Vt = { class: "icons-menu" }, Ht = ["title"], Ut = ["id"], Wt = { class: "modal-container__content" }, Gt = /* @__PURE__ */ c(/* @__PURE__ */ s({
	inheritAttrs: !1,
	__name: "NcModal",
	props: /* @__PURE__ */ N({
		name: { default: "" },
	...
	setup(e, { emit: t }) {
		...
		let i = h(e, "show"), s = e, c = t, l = Lt(), u = he(), f = te("mask"), g;
		m(() => L()), b(() => s.additionalTrapElements, (e) => {
			g && g.updateContainerElements([f.value, ...e]);
		});
		let { isActive: v, pause: y, resume: ee } = ct(M, ce(() => s.slideshowDelay), { immediate: !1 }), C = D(0), T = D(!1);
		r(() => {
			T.value && !s.slideshowPaused ? ee() : v.value && y();
		});
		let E = F(() => `${s.slideshowDelay}ms`), { stop: ie } = gt(f, { onSwipeEnd: ue });
		m(ie), jt("Escape", () => {
			Se().at(-1) === g && P();
		}, { allowInModal: !0 }), jt(["ArrowLeft", "ArrowRight"], (e) => {
			document.activeElement && !f.value.contains(document.activeElement) || (e.key === "ArrowLeft" === we ? M() : N());
		}, { allowInModal: !0 });
		let oe = ne(), se = F(() => {
			let e = 0;
			return s.hasNext && s.enableSlideshow && e++, !s.noClose && s.closeButtonOutside && e++, oe.actions && e++, e;
		});
		d(() => {
			!s.name && !s.labelId && x("[NcModal] You need either set the name or set a `labelId` for accessibility.");
		});
		function M(e) {
			if (!s.hasNext) {
				T.value = !1;
			...
			e && v.value && de(), c("next", e);
		}
		function N(e) {
			s.hasPrevious && (e && v.value && de(), c("previous", e));
		}
		function ue(e, t) {
			if (!s.disableSwipe) {
		...
		function P(e) {
			s.noClose || (i.value = !1, setTimeout(() => {
				c("close", e);
			}, 300));
		}
		function pe(e) {
			s.closeOnClickOutside && P(e);
		}
		async function me() {
			if (g) return;
			await le();
			let e = {
				allowOutsideClick: !0,
				fallbackFocus: f.value,
				trapStack: Se(),
				escapeDeactivates: !1,
				setReturnFocus: s.setReturnFocus
			};
			g = Te([f.value, ...s.additionalTrapElements], e), g.activate();
		}
		function L() {
			g &&= (g?.deactivate(), void 0);
		}
		return (t, r) => (_(), k(ae, {
			...
			default: O(() => [R(A("div", a({
				...
				role: "dialog",
				"aria-modal": "true",
				"aria-labelledby": e.labelId || `modal-name-${U(u)}`,
				"aria-describedby": "modal-description-" + U(u),
				tabindex: "-1"
			}), [H(n, {
				...
				}, [e.name.trim() === "" ? S("", !0) : (_(), V("h2", {
					key: 0,
					id: "modal-name-" + U(u),
					class: "modal-header__name"
				}, o(e.name), 9, Bt)), A("div", Vt, [
					e.hasNext && e.enableSlideshow ? (_(), V("button", {
						key: 0,
						class: w(["play-pause-icons", { "play-pause-icons--paused": e.slideshowPaused }]),
						title: U(v) ? U(j)("Pause slideshow") : U(j)("Start slideshow"),
						type: "button",
						onClick: r[0] ||= (e) => T.value = !T.value
					}, [H(G, {
						class: "play-pause-icons__icon",
						inline: "",
						name: U(v) ? U(j)("Pause slideshow") : U(j)("Start slideshow"),
						path: U(v) ? U(Oe) : U(De)
					}, null, 8, ["name", "path"]), U(v) ? (_(), V("svg", {
						key: `${U(u)}-animation-${C.value}`,
						class: "progress-ring",
						height: "50",
						width: "50"
					}, [...r[1] ||= [A("circle", {
						...
						cx: "25",
						cy: "25"
					}, null, -1)]])) : S("", !0)], 10, Ht)) : S("", !0),
					H(et, {
						class: "header-actions",
						inline: e.inlineActions
					}, {
						default: O(() => [p(t.$slots, "actions", {}, void 0, !0)]),
						_: 3
					}, 8, ["inline"]),
					!e.noClose && e.closeButtonOutside ? (_(), k(W, {
						key: 1,
						"aria-label": U(j)("Close"),
						class: "header-close",
						variant: "tertiary",
						onClick: P
					}, {
						icon: O(() => [H(G, { path: U(je) }, null, 8, ["path"])]),
						_: 1
					}, 8, ["aria-label"])) : S("", !0)
				])], 8, zt)]),
				_: 3
				...
				default: O(() => [R(A("div", {
					class: w(["modal-wrapper", [`modal-wrapper--${e.size}`, { "modal-wrapper--spread-navigation": e.spreadNavigation }]]),
					onMousedown: re(pe, ["self"])
				}, [
					H(n, {
						name: "fade-visibility",
						appear: ""
						...
						default: O(() => [R(H(W, {
							...
							_: 1
						}, 8, ["aria-label"]), [[I, e.hasPrevious]])]),
						_: 1
					}),
					A("div", {
						id: "modal-description-" + U(u),
						class: "modal-container"
					}, [A("div", Wt, [p(t.$slots, "default", {}, void 0, !0)]), !e.noClose && !e.closeButtonOutside ? (_(), k(W, {
						key: 0,
						"aria-label": U(j)("Close"),
					...
					H(n, {
						...
						default: O(() => [R(H(W, {
							...
							_: 1
						}, 8, ["aria-label"]), [[I, e.hasNext]])]),
						_: 1
					})
				], 34), [[I, i.value]])]),
				_: 3
			}, 8, ["name"])], 16, Rt), [[I, i.value]])]),
			_: 3
		})], 8, ["disabled", "to"]));
	}
}), [["__scopeId", "data-v-3c357e2d"]]), Kt = ["id", "textContent"], qt = ["aria-label", "aria-labelledby"], Jt = { class: "dialog__text" }, Yt = { class: "dialog__actions" }, Xt = /* @__PURE__ */ c(/* @__PURE__ */ s({
	__name: "NcDialog",
	props: /* @__PURE__ */ N({
		name: {},
		message: { default: "" },
	...
	setup(e, { emit: t }) {
		let n = h(e, "open"), r = e, i = t, s = ne(), { width: c } = ht(te("wrapper"), {
			width: 900,
			height: 0
		}), l = F(() => c.value < 876), u = F(() => s?.navigation !== void 0), d = he(), m = F(() => r.navigationAriaLabel || void 0), v = F(() => {
			if (!r.navigationAriaLabel) return r.navigationAriaLabelledby || d;
		}), y = te("dialogElement"), b = F(() => r.isForm && !u.value ? "form" : "div"), x = F(() => b.value === "form" ? {
			submit(e) {
		...
		function T(e, t) {
			e.type === "submit" && b.value === "form" && "reportValidity" in y.value && !y.value.reportValidity() || (E(t), window.setTimeout(() => re(), 300));
		}
		function E(e) {
			C.value = !1, i("closing", e);
		}
		function re() {
			C.value = !0, n.value = !1;
		}
		let ie = F(() => ({
			...
			labelId: d,
			size: r.size,
			show: n.value && C.value,
			outTransition: r.outTransition,
			closeOnClickOutside: r.closeOnClickOutside,
			additionalTrapElements: r.additionalTrapElements
		}));
		return (t, r) => n.value ? (_(), k(U(Gt), a({
			key: 0,
			class: "dialog__modal",
			disableSwipe: ""
		}, ie.value, {
			onClose: re,
			"onUpdate:show": r[0] ||= (e) => E()
		}), {
			default: O(() => [A("h2", {
				id: U(d),
				class: "dialog__name",
				textContent: o(e.name)
			}, null, 8, Kt), (_(), k(f(b.value), a({
				ref: "dialogElement",
				class: ["dialog", e.dialogClasses]
			}, g(x.value)), {
				default: O(() => [A("div", {
					ref: "wrapper",
					class: w(["dialog__wrapper", [{ "dialog__wrapper--collapsed": l.value }]])
				}, [u.value ? (_(), V("nav", {
					key: 0,
					class: w(["dialog__navigation", e.navigationClasses]),
					"aria-label": m.value,
					"aria-labelledby": v.value
				}, [p(t.$slots, "navigation", { isCollapsed: l.value }, void 0, !0)], 10, qt)) : S("", !0), A("div", { class: w(["dialog__content", e.contentClasses]) }, [p(t.$slots, "default", {}, () => [A("p", Jt, o(e.message), 1)], !0)], 2)], 2), A("div", Yt, [p(t.$slots, "actions", {}, () => [(_(!0), V(z, null, ee(e.buttons, (e, t) => (_(), k(U(xt), a({ key: t }, { ref_for: !0 }, e, { onClick: (t, n) => T(e, n) }), null, 16, ["onClick"]))), 128))], !0)])]),
				_: 3
			}, 16, ["class"]))]),
			_: 3
		}, 16)) : S("", !0);
	}
}), [["__scopeId", "data-v-24e91b99"]]);
//#endregion
...
//#endregion
//#region node_modules/@nextcloud/dialogs/dist/chunks/index.mjs
var rn = /* @__PURE__ */ e((/* @__PURE__ */ t(((e, t) => {
	(function(e, n) {
		typeof t == "object" && t.exports ? t.exports = n() : e.Toastify = n();
	})(e, function(e) {
		var t = function(e) {
		...
		t.defaults = {
			...
			buildToast: function() {
				...
				if (this.options.ariaLive && e.setAttribute("aria-live", this.options.ariaLive), this.options.node && this.options.node.nodeType === Node.ELEMENT_NODE) e.appendChild(this.options.node);
					...
					r.src = this.options.avatar, r.className = "toastify-avatar", this.options.position == "left" || this.options.positionLeft === !0 ? e.appendChild(r) : e.insertAdjacentElement("afterbegin", r);
				}
				if (this.options.close === !0) {
					...
					(this.options.position == "left" || this.options.positionLeft === !0) && a > 360 ? e.insertAdjacentElement("afterbegin", i) : e.appendChild(i);
				}
				...
				if (this.options.destination !== void 0 && e.addEventListener("click", function(e) {
				...
				}.bind(this)), typeof this.options.onClick == "function" && this.options.destination === void 0 && e.addEventListener("click", function(e) {
					e.stopPropagation(), this.options.onClick();
				}.bind(this)), typeof this.options.offset == "object") {
					var s = n("x", this.options), c = n("y", this.options), l = this.options.position == "left" ? s : "-" + s, u = this.options.gravity == "toastify-top" ? c : "-" + c;
			...
			showToast: function() {
				...
				var e = typeof this.options.selector == "string" ? document.getElementById(this.options.selector) : this.options.selector instanceof HTMLElement || typeof ShadowRoot < "u" && this.options.selector instanceof ShadowRoot ? this.options.selector : document.body;
				if (!e) throw "Root element is not defined";
			...
			for (var e = {
				...
				top: 15,
				bottom: 15
			}, i = document.getElementsByClassName("toastify"), a, o = 0; o < i.length; o++) {
				a = r(i[o], "toastify-top") === !0 ? "toastify-top" : "toastify-bottom";
				var s = i[o].offsetHeight;
				a = a.substr(9, a.length - 1);
				var c = 15;
				(window.innerWidth > 0 ? window.innerWidth : screen.width) <= 360 ? (i[o].style[a] = n[a] + "px", n[a] += s + c) : r(i[o], "toastify-left") === !0 ? (i[o].style[a] = e[a] + "px", e[a] += s + c) : (i[o].style[a] = t[a] + "px", t[a] += s + c);
			}
			return this;
		};
		function n(e, t) {
		...
		function r(e, t) {
			return !e || typeof t != "string" ? !1 : !!(e.className && e.className.trim().split(/\s+/gi).indexOf(t) > -1);
		}
		return t.lib.init.prototype = t.lib, t;
	});
})))(), 1), an = "<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"mdi-folder-move\" viewBox=\"0 0 24 24\"><path d=\"M14,18V15H10V11H14V8L19,13M20,6H12L10,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V8C22,6.89 21.1,6 20,6Z\" /></svg>", on = "<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"mdi-folder-multiple\" viewBox=\"0 0 24 24\"><path d=\"M22,4H14L12,2H6A2,2 0 0,0 4,4V16A2,2 0 0,0 6,18H22A2,2 0 0,0 24,16V6A2,2 0 0,0 22,4M2,6H0V11H0V20A2,2 0 0,0 2,22H20V20H2V6Z\" /></svg>", sn = l().detectLanguage();
for (let e of [
	{
		language: "ar",
		translations: [
	...
	},
	{
		...
		translations: [
			...
			{
				msgid: "\"{name}\" is an invalid folder name.",
				msgstr: ["\"{name}\" no és vàlid com a nom de carpeta."]
			},
			{
				msgid: "\"{name}\" is not an allowed folder name",
				msgstr: ["\"{name}\" no és vàlid com a nom de carpeta"]
			...
			{
				msgid: "\"/\" is not allowed inside a folder name.",
				msgstr: ["\"/\" no està permès en el nom d'una carpeta."]
			},
			{
				msgid: "%n file conflict",
				msgid_plural: "%n files conflict",
				msgstr: ["%n conflicte de fitxers", "%n conflictes de fitxers"]
			},
			{
				msgid: "%n file conflict in {dirname}",
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: ["%n onflicte de fitxers a {dirname}", "%n conflictes de fitxers a {dirname}"]
			},
			{
				msgid: "All files",
			...
			{
				msgid: "Folder name cannot be empty.",
				msgstr: ["El nom de la carpeta no pot estar buit."]
			},
			{
			...
			},
			{
				...
				msgstr: ["Si seleccioneu les dues versions, el fitxer entrant tindrà un número afegit al seu nom."]
			},
			{
				msgid: "Invalid name.",
				msgstr: ["Nom no vàlid."]
			...
			},
			{
				...
				msgstr: ["Selecciona tots els fitxers existents"]
			},
			{
				msgid: "Select all new files",
				msgstr: ["Selecciona tots els fitxers nous"]
			},
			{
				msgid: "Select entry",
			...
			},
			{
				...
				msgstr: ["Quan es selecciona una carpeta entrant, també se sobreescriuran els fitxers que hi entrin en conflicte."]
			},
			{
				...
				msgstr: ["Quan es selecciona una carpeta entrant, el contingut s'escriu a la carpeta existent i es realitza una resolució recursiva de conflictes."]
			},
			{
				msgid: "Which files do you want to keep?",
				msgstr: ["Quins fitxers voleu conservar?"]
			},
			{
	...
	},
	{
		...
		translations: [
			...
			},
			{
				msgid: "%n file conflict",
				msgid_plural: "%n files conflict",
				msgstr: ["%n Dateikonflikt", "%n Dateikonflikte"]
			},
			{
				msgid: "%n file conflict in {dirname}",
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: ["%n Dateikonflikt in {dirname}", "%n Dateikonflikte in {dirname}"]
			},
			{
				msgid: "All files",
				msgstr: ["Alle Dateien"]
			...
			{
				msgid: "If you select both versions, the incoming file will have a number added to its name.",
				msgstr: ["Wenn beide Versionen ausgewählt werden, wird dem Namen der eingehenden Datei eine Nummer hinzugefügt."]
			},
			{
				msgid: "Invalid folder name.",
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["Wenn ein eingehender Ordner ausgewählt wird, werden auch alle darin enthaltenen Dateien mit Konflikten überschrieben."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["Wenn ein eingehender Ordner ausgewählt wird, werden auch alle darin enthaltenen Dateien überschrieben."]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["Bei Auswahl eines eingehenden Ordners wird der Inhalt in den vorhandenen Ordner geschrieben und eine rekursive Konfliktlösung durchgeführt."]
			},
			{
				msgid: "Which files do you want to keep?",
				msgstr: ["Welche Dateien sollen behalten werden?"]
			},
			{
				msgid: "You are currently identified as {nickname}.",
	...
	},
	{
		...
		translations: [
			...
			},
			{
				msgid: "%n file conflict",
				msgid_plural: "%n files conflict",
				msgstr: ["%n fail on vastuolus", "%n faili on omavahel vastuolus"]
			},
			{
				msgid: "%n file conflict in {dirname}",
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: ["%n fail on {dirname} kaustas vastuolus", "%n faili on omavahel {dirname} kaustas vastuolus"]
			},
			{
				msgid: "All files",
				msgstr: ["Kõik failid"]
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["Kui uute failide kaust on valitud, siis kõik seal leiduvad vastuolus failid saavad üle kirjutatud."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["Kui uute (saabuvate) failide kaust on valitud, siis kõik seal leiduvad failid saavad samuti üle kirjutatud."]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["Kui uute failide kaust on valitud, siis sisu kirjutatakse olemasolevasse kausta ja korraldatakse rekursiivne failikonfliktide lahendamine."]
			},
			{
				msgid: "Which files do you want to keep?",
	...
	},
	{
		...
		translations: [
			...
			},
			{
				...
				msgid_plural: "%n files conflict",
				msgstr: [
					"%n conflit de fichier",
					"%n conflit de fichiers",
					"%n conflit de fichiers"
				]
			},
			{
				...
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: [
					"%nconflit de fichier dans {dirname}",
					"%n conflit de fichiers dans {dirname}",
					"%nconflit de fichiers dans {dirname}"
				]
			},
			{
				msgid: "All files",
			...
			{
				msgid: "If you select both versions, the incoming file will have a number added to its name.",
				msgstr: ["Si vous conservez les deux versions, le fichier reçu sera renommé avec un numéro."]
			},
			{
				msgid: "Invalid folder name.",
			...
			{
				msgid: "Select all existing files",
				msgstr: ["Sélectionner tous les fichiers existants"]
			},
			{
				msgid: "Select all new files",
				msgstr: ["Sélectionner tous les nouveaux fichiers"]
			},
			{
				msgid: "Select entry",
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["En sélectionnant un dossier entrant, les fichiers en conflit qu’il contient seront automatiquement écrasés."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["Suite à la sélection d'un dossier en entrée, tout fichier présent dans ce dossier sera alors écrasé. "]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["Lorsque vous sélectionnez un dossier entrant, son contenu est ajouté au dossier existant et les conflits sont résolus automatiquement."]
			},
			{
				msgid: "Which files do you want to keep?",
				msgstr: ["Quels fichiers souhaitez-vous conserver ?"]
			},
			{
				msgid: "You are currently identified as {nickname}.",
	...
	},
	{
		...
		translations: [
			...
			},
			{
				...
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: [
					"%n coimhlint comhaid i {dirname}",
					"%n coimhlintí comhaid i {dirname}",
					"%n coimhlintí comhaid i {dirname}",
					"%n coimhlintí comhaid i {dirname}",
					"%n coimhlintí comhaid i {dirname}"
				]
			...
			{
				msgid: "If you select both versions, the incoming file will have a number added to its name.",
				msgstr: ["Má roghnaíonn tú an dá leagan, cuirfear uimhir le hainm an chomhaid atá ag teacht isteach."]
			},
			{
				msgid: "Invalid folder name.",
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["Nuair a roghnaítear fillteán isteach, déanfar aon chomhaid choimhlinteacha ann a athscríobh freisin."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["Nuair a roghnaítear fillteán isteach, déanfar aon chomhaid laistigh de a athscríobh freisin."]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["Nuair a roghnaítear fillteán isteach, scríobhtar an t-ábhar isteach sa fhillteán atá ann cheana féin agus déantar réiteach coinbhleachta athchúrsach."]
			},
			{
				msgid: "Which files do you want to keep?",
	...
	},
	{
		...
		translations: [
			...
			},
			{
				msgid: "%n file conflict",
				msgid_plural: "%n files conflict",
				msgstr: ["%n bestanden conflicteren", "%nbestand bestanden conflicteren"]
			},
			{
				msgid: "%n file conflict in {dirname}",
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: ["%n bestand conflicteerd in {dirname}", "%nbestanden conflicteert in {dirname}"]
			},
			{
				msgid: "All files",
			...
			{
				msgid: "Could not create the new folder",
				msgstr: ["Kon de nieuwe map niet maken"]
			},
			{
				msgid: "Could not load files settings",
				msgstr: ["Kon de bestandsinstellingen niet laden"]
			},
			{
				msgid: "Could not load files views",
				msgstr: ["Kon de bestandsweergaves niet laden"]
			},
			{
				msgid: "Create directory",
				msgstr: ["Map aanmaken"]
			...
			{
				msgid: "Files and folders you mark as favorite will show up here.",
				msgstr: ["Bestanden en mappen die je als favoriet markeert, verschijnen hier."]
			},
			{
				msgid: "Files and folders you recently modified will show up here.",
				msgstr: ["Bestanden en mappen die je recentelijk hebt gewijzigd, verschijnen hier."]
			},
			{
				msgid: "Filter file list",
			...
			{
				msgid: "If you select both versions, the incoming file will have a number added to its name.",
				msgstr: ["Als u beide versies selecteert wordt een nummer toegevoegd aan de naam van het binnenkomende bestand."]
			},
			{
				msgid: "Invalid folder name.",
			...
			{
				msgid: "Names must not start with a dot.",
				msgstr: ["Namen mogen niet begonnen met een punt."]
			},
			{
				msgid: "New",
				msgstr: ["Nieuw"]
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["Als een inkomende map wordt geselecteerd, worden alle conflicterende bestanden daarin overschreven."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["Wanneer een inkomende folder is geselecteerd, worden bestanden in deze folder ook overschreven."]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["Als een inkomende map wordt geselecteerd, wordt de inhoud naar de bestaande map geschreven en wordt een recursieve conflict-oplossing uitgevoerd."]
			},
			{
				msgid: "Which files do you want to keep?",
	...
	},
	{
		...
		translations: [
			...
			},
			{
				...
				msgstr: [
					"%n arquivo conflita",
					"%n de arquivos conflitam",
					"%n arquivos conflitam"
				]
			},
			{
				msgid: "%n file conflict in {dirname}",
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: [
					"%n conflito de arquivo em {dirname}",
					"%n de conflitos de arquivos em {dirname}",
					"%n conflitos de arquivos em {dirname}"
				]
			},
			{
				msgid: "All files",
			...
			{
				msgid: "If you select both versions, the incoming file will have a number added to its name.",
				msgstr: ["Se você selecionar ambas as versões, um número será adicionado ao nome do arquivo recebido."]
			},
			{
				msgid: "Invalid folder name.",
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["Ao selecionar uma pasta de entrada, quaisquer arquivos conflitantes dentro dela também serão sobrescritos."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["Quando uma pasta de entrada for selecionada, todos os arquivos nela contidos também serão substituídos."]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["Quando uma pasta de entrada é selecionada, o conteúdo é gravado na pasta existente e uma resolução recursiva de conflitos é realizada."]
			},
			{
				msgid: "Which files do you want to keep?",
	...
	},
	{
		...
		translations: [
			...
			},
			{
				msgid: "%n file conflict",
				msgid_plural: "%n files conflict",
				msgstr: ["%n fil är i konflikt", "%n filer är i konflikt"]
			},
			{
				msgid: "%n file conflict in {dirname}",
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: ["%n fil är i konflikt i {dirname}", "%n filer är i konflikt i {dirname}"]
			},
			{
				msgid: "All files",
				msgstr: ["Alla filer"]
			...
			{
				msgid: "Could not load files settings",
				msgstr: ["Kunde inte ladda filinställningar"]
			},
			{
				msgid: "Could not load files views",
				msgstr: ["Kunde inte ladda filvyer"]
			},
			{
				msgid: "Create directory",
			...
			{
				msgid: "If you select both versions, the incoming file will have a number added to its name.",
				msgstr: ["Om du väljer båda versionerna kommer den inkommande filen att få ett nummer tillagt i sitt namn."]
			},
			{
				msgid: "Invalid folder name.",
			...
			{
				msgid: "Names may be at most 64 characters long.",
				msgstr: ["Namnen kan vara högst 64 tecken långa."]
			},
			{
				msgid: "Names must not be empty.",
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["När en inkommande mapp väljs kommer eventuella konflikterande filer i den också att skrivas över."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["När en inkommande mapp väljs kommer även filer i den att skrivas över."]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["När en inkommande mapp väljs skrivs innehållet in i den befintliga mappen och en rekursiv konfliktlösning utförs."]
			},
			{
				msgid: "Which files do you want to keep?",
			...
			{
				msgid: "You are currently not identified.",
				msgstr: ["Du är för närvarande inte identifierad."]
			},
			{
				msgid: "You cannot leave the name empty.",
	...
	},
	{
		...
		translations: [
			...
			},
			{
				msgid: "%n file conflict",
				msgid_plural: "%n files conflict",
				msgstr: ["%n dosya çakışıyor", "%n dosya çakışıyor"]
			},
			{
				msgid: "%n file conflict in {dirname}",
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: ["{dirname} içindeki %n dosya çakışıyor", "{dirname} içindeki %n dosya çakışıyor"]
			},
			{
				msgid: "All files",
				msgstr: ["Tüm dosyalar"]
			...
			{
				msgid: "Select all existing files",
				msgstr: ["Tüm var olan dosyaları seç"]
			},
			{
				msgid: "Select all new files",
				msgstr: ["Tüm yeni dosyaları seç"]
			},
			{
				msgid: "Select entry",
				msgstr: ["Kaydı seç"]
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["Bir gelen klasör seçildiğinde, içindeki çakışan dosyaların da üzerine yazılır."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["Bir gelen klasör seçildiğinde, içindeki dosyaların da üzerine yazılır."]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["Bir gelen klasör seçildiğinde, içerik var olan klasöre yazılır ve alt klasörlerle bir çakışma çözümü uygulanır."]
			},
			{
				msgid: "Which files do you want to keep?",
				msgstr: ["Hangi dosyaları tutmak istiyorsunuz?"]
			},
			{
				msgid: "You are currently identified as {nickname}.",
	...
	},
	{
		...
		translations: [
			...
			},
			{
				...
				msgid_plural: "%n file conflicts in {dirname}",
				msgstr: [
					"%n конфлікт файлів у каталозі {dirname}",
					"%n конфлікти файлів у каталозі {dirname}",
					"%n конфліктів файлів у каталозі {dirname}",
					"%n конфліктів файлів у каталозі {dirname}"
				]
			},
			{
			...
			{
				msgid: "If you select both versions, the incoming file will have a number added to its name.",
				msgstr: ["Якщо вибрати обидві версії, до назви вхідного файлу буде додано цифру. "]
			},
			{
				msgid: "Invalid folder name.",
			...
			{
				msgid: "When an incoming folder is selected, any conflicting files within it will also be overwritten.",
				msgstr: ["Коли вибрано вхідний каталог, будь-які файли з конфліктами буде також перезаписано."]
			},
			{
				msgid: "When an incoming folder is selected, any files within it will also be overwritten.",
				msgstr: ["Якщо буде вибрано вхідний каталог, будь-який файл в ньому буде також перезаписано."]
			},
			{
				msgid: "When an incoming folder is selected, the content is written into the existing folder and a recursive conflict resolution is performed.",
				msgstr: ["Коли вибрано вхідний каталог, вміст буде записано до існуючого каталогу, а також виконано вирішення конфліктів всередині каталогу."]
			},
			{
				msgid: "Which files do you want to keep?",
	...
	sn.addTranslation(t, r);
}
var Q = sn.build(), cn = Q.ngettext.bind(Q), $ = Q.gettext.bind(Q), ln = Ce().setApp("@nextcloud/dialogs").detectLogLevel().build(), un = class extends Error {}, dn = class {
	title;
	multiSelect;
	mimeTypeFilter;
	directoriesAllowed;
	...
	async pickNodes() {
		let { default: e } = await import("./FilePicker-Blp6nIS6.chunk.mjs"), t = await Zt(e, {
		...
		if (!Array.isArray(t) || t.length === 0) throw new un("FilePicker: No nodes selected");
		return t;
	}
	async pick() {
	...
	addButton(e) {
		return typeof this.buttons == "function" && (ln.warn("FilePicker buttons were set to factory, now overwritten with button object."), this.buttons = []), this.buttons.push(e), this;
	}
	setButtonFactory(e) {
	...
	setType(e) {
		return this.buttons = (t, n) => {
			let r = [], i = t[0]?.displayname || $t(n);
			if (e === 1) {
				let e = $("Choose");
				t.length === 1 ? e = $("Choose {file}", { file: i }) : this.multiSelect && (e = cn("Choose %n file", "Choose %n files", t.length)), r.push({
					callback: () => {},
					label: e,
					variant: "primary"
				});
			...
			return (e === 4 || e === 3) && r.push({
				callback: () => {},
				label: i ? $("Copy to {target}", { target: i }) : $("Copy"),
				icon: on,
				variant: e === 3 ? "primary" : "secondary"
			}), (e === 4 || e === 2) && r.push({
				callback: () => {},
				label: i ? $("Move to {target}", { target: i }) : $("Move"),
				icon: an,
				variant: "primary"
			}), r;
		}, this;
	...
	build() {
		return new dn(this.title, this.multiSelect, this.mimeTypeFilter, this.directoriesAllowed, this.noMenu, this.buttons, this.path, this.filter, this.canPick, this.container, this.disabledNavigation);
	}
};
function pn(e) {
	return new fn(e);
}
var mn = "polite", hn = "assertive", gn = /* @__PURE__ */ ((e) => (e[e.OFF = "off"] = "OFF", e[e.POLITE = mn] = "POLITE", e[e.ASSERTIVE = hn] = "ASSERTIVE", e))(gn || {}), _n = 7e3;
function vn(e, t) {
	if (t = {
		timeout: _n,
		isHTML: !1,
		...
		close: !0,
		...t
	}, typeof e == "string" && !t.isHTML) {
		let t = document.createElement("div");
		t.innerHTML = e, e = t.innerText;
	}
	let n = t.type ?? "";
	typeof t.onClick == "function" && (n += " toast-with-click ");
	let r = e instanceof Node, i = gn.POLITE;
	t.ariaLive ? i = t.ariaLive : (t.type === "toast-error" || t.type === "toast-undo") && (i = gn.ASSERTIVE);
	let a = (0, rn.default)({
		[r ? "node" : "text"]: e,
		duration: t.timeout,
		callback: t.onRemove,
...
//#endregion
export { Ve as C, He as S, gt as _, yn as a, et as b, en as c, nn as d, Xt as f, bt as g, wt as h, cn as i, Qt as l, Ct as m, pn as n, $ as o, Gt as p, ln as r, $t as s, un as t, tn as u, nt as v, Be as w, Ze as x, tt as y };
