...
var i = {
	...
	let r, o = i[e];
	return r = typeof o == "string" ? o : t === 1 ? o.one : o.other.replace("{{count}}", t < 13 ? a[t] : String(t)), n?.addSuffix ? n.comparison && n.comparison > 0 ? "om " + r : r + " sedan" : r;
}, s = {
	date: e({
		formats: {
			full: "EEEE d MMMM y",
