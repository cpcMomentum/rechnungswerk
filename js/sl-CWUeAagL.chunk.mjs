...
var s = (e, t, n) => {
	let r = "", s = "present";
	n?.addSuffix && (n.comparison && n.comparison > 0 ? (s = "future", r = "čez ") : (s = "past", r = "pred "));
	let c = a[e];
	if (typeof c == "string") r += c;
	else {
		let e = o(t);
		i(c) ? r += c[e].replace("{{count}}", String(t)) : r += c[s][e].replace("{{count}}", String(t));
	}
	return r;
}, c = {
	date: e({
