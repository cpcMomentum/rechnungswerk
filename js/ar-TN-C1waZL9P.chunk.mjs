...
var i = {
	...
	let r = i[e], a;
	return a = typeof r == "string" ? r : t === 1 ? r.one : t === 2 ? r.two : t <= 10 ? r.threeToTen.replace("{{count}}", String(t)) : r.other.replace("{{count}}", String(t)), n?.addSuffix ? n.comparison && n.comparison > 0 ? "في " + a : "عندو " + a : a;
}, o = {
	date: e({
		formats: {
			full: "EEEE، do MMMM y",
