...
var i = {
	...
	let r, a = i[e];
	r = a.type === "other" ? a.other : t === 1 ? a.one : t > 1 && t < 5 ? a.few : a.many;
	let o = n?.addSuffix === !0, s = n?.comparison, c;
	return c = o && s === -1 ? r.past : o && s === 1 ? r.future : r.regular, c.replace("{{count}}", String(t));
}, o = {
	date: e({
		formats: {
