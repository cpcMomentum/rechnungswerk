...
function o(e, t, n) {
	return a(e, t)[n].replace("{{count}}", String(t));
}
function s(e) {
	return [
		"lessThan",
...
var d = {
	...
	let r = s(e) || "", i = d[u(e.substring(r.length))];
	return n?.addSuffix ? n.comparison && n.comparison > 0 ? c(r) + "o " + l(r) + o(i, t, "future") : c(r) + "pred " + l(r) + o(i, t, "past") : c(r) + l(r) + o(i, t, "present");
}, p = {
	date: e({
		formats: {
			full: "EEEE d. MMMM y",
