...
var a = {
	...
	let r = n?.addSuffix ? n.comparison && n.comparison > 0 ? "in" : "ago" : "default", o = a[e];
	return i(o) ? t === 1 ? o.one[r] : o.other[r].replace("{{count}}", String(t)) : o[r];
}, s = {
	date: e({
		formats: {
			full: "EEEE, d MMMM, y",
