...
var i = {
	...
	let r, a = i[e];
	return r = typeof a == "string" ? a : t === 1 ? a.one : t === 2 && a.two ? a.two : t === 20 && a.twenty ? a.twenty : a.other.replace("{{count}}", String(t)), n?.addSuffix ? n.comparison && n.comparison > 0 ? "ann an " + r : "o chionn " + r : r;
}, o = {
	date: e({
		formats: {
			full: "EEEE, MMMM do, y",
