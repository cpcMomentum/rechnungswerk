...
var c = (e, t, n) => {
	let r = a[e];
	return n?.addSuffix ? n.comparison && n.comparison > 0 ? "za " + s(r, t, "future") : s(r, t, "past") + " temu" : s(r, t, "regular");
}, l = {
	date: e({
		formats: {
			full: "EEEE, do MMMM y",
...
function m(e, t, n, r) {
	let a;
	if (i(t, n, r)) a = d;
	else if (e === "lastWeek") a = u;
	else if (e === "nextWeek") a = f;
